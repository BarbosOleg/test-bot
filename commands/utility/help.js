...
module.exports = {
	...
	execute(msg, args) {
        ...
        {
            /**
             *  map over the command collection and add a string to let the 
             * user know how to trigger information about a specific command
             */
        ...
        const cmd = commands.get(name) || commands.find(c => c.aliases && c.aliases.include(name));
